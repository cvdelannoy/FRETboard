...
class FretReport(object):
    def __init__(self, classifier, data, algo_name, buffer, supervision_influence, bootstrap_size):
    ...
    def construct_html_report(self):
        ...
        with open(f'{__location__}/../FRETboard/templates/report_template.html', 'r') as fh:
    ...
    def model_params(self):
        ...
        out_str = f"""
        Algorithm: {self.algo_name} <br/>
        Number of states: {self.classifier.nb_states} <br/>
        Supervision influence: {self.supervision_influence} <br/>
        Buffer size: {self.buffer} <br/>
